...
func init(parent: CharacterBody2D, animations: AnimatedSprite2D, effects: AnimatedSprite2D, input_handler: Node, body_audio: AudioStreamPlayer2D, voice_audio: AudioStreamPlayer2D) -> void:
